			...
			<div className="container nextOne__container">
				<div className="nextOne__head">
					...
					{/*<div className="nextOne__head-navbar">
						...
						<div className={ isNextNavClicked ? "nextOne__head-navbar-responsive-menu" : "nextOne__head-navbar-responsive-menu nextfalse" }>
							<ul>
								<li>
									<Link to={`/game/homeGen-1/`}>Genshin Impact</Link>
								</li>
								<li>
									<Link to="/game/homeGen-2/" replace={true}>Tower of Fantasy</Link>
								</li>
							</ul>
						</div>		
					</div>*/}
				...
				<div className="nextOne__footer">
					...
					<div className="nextOne__footer-footer">
						<h4 className="nextOne__footer-footer-text">Miniguide Info Site</h4>
						<h4 className="nextOne__footer-footer-text">Created by Muhammad Ikhsan 2022. All Rights Reserved</h4>
					</div>
				</div>
			</div>
		</section>
